...
yumiao2007::yumiao2007(GameCore *game_core, uint32_t id, uint32_t player_id)
...
void yumiao2007::Update() {
  TankMove(3.0f, glm::radians(180.0f));
  TurretRotate();
  Fire();
}

void yumiao2007::TankMove(float move_speed, float rotate_angular_speed) {
...
void yumiao2007::Fire() {
  if (fire_count_down_ == 0) {
    auto player = game_core_->GetPlayer(player_id_);
    if (player) {
      auto &input_data = player->GetInputData();
      if (input_data.mouse_button_down[GLFW_MOUSE_BUTTON_LEFT]) {
        auto velocity1 = Rotate(glm::vec2{0.0f, 20.0f}, turret_rotation_ - glm::radians(10.0f));
        auto velocity2 = Rotate(glm::vec2{0.0f, 20.0f}, turret_rotation_ + glm::radians(10.0f));
        auto velocity3 = Rotate(glm::vec2{0.0f, 20.0f}, turret_rotation_ + glm::radians(0.0f));
...
bool yumiao2007::IsHit(glm::vec2 position) const {
...
const char *yumiao2007::UnitName() const {
  return "yumiao2007";
}

const char *yumiao2007::Author() const {
  return "s-yu24";
}
}  // namespace battle_game::unit
